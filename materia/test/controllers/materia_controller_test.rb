...
class MateriaControllerTest < ActionController::TestCase
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post :create, materium: { codigo: @materium.codigo, materia: @materium.materia, profesor: @materium.profesor }
    end
  ...
  test "should update materium" do
    patch :update, id: @materium, materium: { codigo: @materium.codigo, materia: @materium.materia, profesor: @materium.profesor }
    assert_redirected_to materium_path(assigns(:materium))
  end
